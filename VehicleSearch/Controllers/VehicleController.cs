...
namespace VehicleSearch.Controllers
{
    public class VehicleController : ApiController
    {
        ...
        private List<Vehicle> GetVehicles()
        {
            ...
            return new List<Vehicle>() { new Vehicle { Make = "Ford", Model = "Mustang", Year = 1965, Condition = VehicleCondition.Used, Price = 65999.99m },
                new Vehicle { Make = "Ford", Model = "F150", Year = 2020, Condition = VehicleCondition.New, Price = 53230.99m }, 
                new Vehicle { Make = "Cheverolet", Model = "Camaro", Year = 2016, Condition = VehicleCondition.New, Price = 32999.99m }
            };
        }
    }
}
